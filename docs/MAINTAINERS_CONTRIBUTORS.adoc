...
The `Releases` tab on GitHub has assembled a changelog draft. Edit it and select the tag you want to associate the release with. +
If the GitHub actions workflow reported a complete and successful result for the release commit, a new version has been published to the central repository. +
